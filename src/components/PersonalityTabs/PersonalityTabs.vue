...
export default {
            ...
            size64: [
                {
                    ...
                    personalitySrc: 'img/personality/planta-unicos.jpg'
                }/* ,
                {
                    title: 'Tradicionales',
                    description: '3 Alcobas',
                    personalitySrc: 'img/personality/planta-tradicionales.jpg'
                } */
            ],
            size54: [
                {
                    ...
                    personalitySrc: 'img/personality/planta-practicos.jpg'
                },
                {
                    title: 'Anfitriones',
                    description: '1 Alcoba ampliada + Huésped',
                    personalitySrc: 'img/personality/planta-anfitriones.jpg'
                },
                {
                    title: 'Emprendedores',
                    description: '1 Alcoba ampliada + Estudio',
                    personalitySrc: 'img/personality/planta-emprendedores.jpg'
                },
                {
                    title: 'Conectados',
                    description: '1 Alcoba con estudio en la alcoba principal',
                    personalitySrc: 'img/personality/planta-conectados.jpg'
                },
                {
                    title: 'Sofisticados',
                    description: '1 Alcoba + Estudio en la zona social',
                    personalitySrc: 'img/personality/planta-sofisticados.jpg'
                }
            ]   
        }
    },
    mounted() {
        ...
        this.sizeStr = size;
        this.items = this.sizeStr === '54 M2' ? this.size54 : this.size64;
    },
    computed: {
        pointer(){
    ...
    methods: {
        ...
        notifySelection(n) {
            const sizeData = this.sizeStr === '54 M2' ? this.size54 : this.size64;
