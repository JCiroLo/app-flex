    ...
    <div class="bar-container d-none d-md-flex">
        ...
        <div class="container p-3">
            <div class="p-y d-flex align-items-center flex-column mb-6">
                <img src="../assets/img/ReflexLogoWhite.png" alt width="200" />
            </div>
...
export default {
    ...
    created () {
        ...
        if (this.currentView === 'city-reflex') {
            this.chooseApartmentUrl = '/choose-city-reflex';
            this.personalityUrl = '/personality-city-reflex';
            this.reserveUrl = '/apartment-reservation-city-reflex';
        } else if (this.currentView === 'mountain'){
