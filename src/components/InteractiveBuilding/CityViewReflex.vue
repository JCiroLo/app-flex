    ...
    <div class="row">
      ...
      <div class="int-container">
        ...
        <div class="outer-layout py-2">
          ...
          <img class="building-img" src="../../assets/img/Edificio1.png" />
        ...
        <div class="col-12">
          <div class="text-center py-2">
            <img
              size="30"
              class="img-fluid"
              src="img/previews/preview-Reflex-ciudad.jpg"
              @click="modal1 = true"
            />
          </div>
        </div>
...
export default {
  ...
  data () {
    return {
      modal1: false,
      panoramicSrc: 'img/previews/preview-Reflex-ciudad.jpg',
      selectedApt: '',
      selectedFloor: ''
    }
  },
  methods: {
    ...
    changePanoramicImage (floorNumber) {
      if (floorNumber <= 10) {
        this.panoramicSrc = 'img/previews/reflex-p3-9-ciudad.jpg'
      } else {
        this.panoramicSrc = 'img/previews/reflex-p10-18-ciudad.jpg'
      }
    }
  }
}
