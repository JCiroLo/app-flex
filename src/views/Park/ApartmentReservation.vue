            ...
            <div class="apt-specification d-flex justify-content-center py-3">
              <div class="row">
                <ul class="inline">
                  ...
                  >{{ (apartment.view == 'vista-ciudad') ? "Con vista a la Ciudad": "Con vista al Parque"}}</li>
    ...
    checkAvailable() {
      return new Promise((resolve, reject) => {
        ...
        Promise.all([reservedPr, wonPr]).then((values) => {
          ...
          allData = allData.filter(lead => lead.custom.view && lead.custom.view === 'vista-parque');
