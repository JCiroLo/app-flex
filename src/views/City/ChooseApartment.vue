...
<script>
import CityView from '../../components/InteractiveBuilding/CityView';
...
export default {
          ...
          apartments: [
            {
              ...
              isSold: false,
              size: "54 M2",
              image: "img/apartments/Vista-a-la-ciudad-planta-1.jpg",
            },
            {
              apartment: 14,
              isReserved: false,
              isSold: false,
              size: "64 M2",
              image: "img/apartments/Vista-a-la-ciudad-planta-2.jpg",
            },
            {
              apartment: 15,
              isReserved: false,
              isSold: false,
              size: "54 M2",
              image: "img/apartments/Vista-a-la-ciudad-planta-3.jpg",
            },
          ],
        },
        {
  ...
  created () {
    ...
    .then(data => {
      ...
      processData = processData.filter(lead => lead.custom.view && lead.custom.view === 'vista-ciudad');
  ...
  components: { CityView, NavArrows, CustomSideBar }
}
</script>
<style scoped>
.full-height {
