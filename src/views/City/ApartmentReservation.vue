            ...
            <div class="apt-specification d-flex justify-content-center py-3">
              <div class="row">
                <ul class="inline">
                  ...
                  <li class="d-block d-md-inline">Valor: {{ (apartment.size == '54 M2') ? "desde $325.000.000 " : (apartment.size == '64 M2') ? "$321.800.000" : "$0" }}</li>
                </ul>
              </div>
            </div>
    ...
    checkAvailable() {
      return new Promise((resolve, reject) => {
        ...
        Promise.all([reservedPr, wonPr]).then((values) => {
          ...
          allData = allData.filter(lead => lead.custom.view && lead.custom.view === 'vista-ciudad');
