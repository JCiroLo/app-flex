        ...
        <div class="col background-white pa-1 full-height pt-4">
          ...
          <div class="container">
            ...
            <p class="p-general-text text-center">
              ¡Excelente! Ahora sigue lo mejor, porque este apartamento lo puedes personalizar. Elige la opción que mejor se adapte a tu personalidad y te lo entregamos sin acabados para que lo termines a tu gusto.
            </p>
            <!-- Sart tabs -->
          ...
          <NavArrows 
            :canContinue="showNextArrow" 
            prevUrl="/choose-city-Apartment"
            nextUrl="/apartment-reservation-city"
          />
        </div>
      </div>
    </div>
...
<script>
import PersonalityTabs from '../../components/PersonalityTabs/PersonalityTabs.vue';
